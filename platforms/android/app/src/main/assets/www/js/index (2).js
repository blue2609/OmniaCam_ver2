...
function takePicture(){
    ...
    //get the maximum supported resolution for this device's camera
    CameraPreview.getSupportedPictureSizes(function(dimensions){
         console.log("maximum resolution supported by the camera is " + dimensions[0].width + 'x' + dimensions[0].height);
         maxHeight = dimensions[0].height;
         maxWidth = dimensions[0].width;
    });
    ...
    CameraPreview.takePicture({height:maxHeight, width:maxWidth, quality: 100}, function(picture){
      ...
      // //get all supported picture dimensions on this device and pick
      // // the laregest one
      // CameraPreview.getSupportedPictureSizes(function(dimensions){
      //   // note that the portrait version, width and height swapped, of these dimensions are also supported
      //   dimensions.forEach(function(dimension) {
      //     console.log("INSIDE CameraPreview.takePicture()" + dimension.width + 'x' + dimension.height);
      //   });
      // });
